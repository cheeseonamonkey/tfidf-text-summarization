...
### common.py
This script demonstrates an example usage of the `tfidf.py` module. It takes a corpus zip and a target filename, extracts the text, and prints the top 10 most frequent stemmed words.
